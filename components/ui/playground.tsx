    ...
    export default function Playground() {
        ...
        const sendTranscript = async () => {
            if (finalTranscript.trim() !== '') {
                ...
                ttsRef.current?.generateTTS('Testing');
                ttsRef.current?.generateTTS('I am testing');
                ttsRef.current?.generateTTS('Can we have seggs?');
                ttsRef.current?.generateTTS('Very brutal seggs');
                ttsRef.current?.generateTTS('Please');
                // append({
                //     role: "user",
